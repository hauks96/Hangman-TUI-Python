...
The interface is seperated into a graphical constructor, a graphical handler which uses the constructor
and a interface handler which controls all of the mentioned and communicates with the logic layer.

The logic layer is seperated by only a game Instance and the logic itself. The game instance is controlled 
by the logic class. The logic class handles all communications between the game and the server. 
